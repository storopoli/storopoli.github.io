...
tibble::tribble(
  ...
  "Estatística Bayesiana - Bayesian Statistics", 2020L,  "https://storopoli.io/Estatistica-Bayesiana", "R and RStan"
) %>%
  detailed_entries(
    what = language,
    when = year,
...
tibble::tribble(
  ~title, ~link, ~year,
  "Fluência de Dados e Carreira Profissional", "https://youtu.be/nAo1GS82Jv0", 2021,
